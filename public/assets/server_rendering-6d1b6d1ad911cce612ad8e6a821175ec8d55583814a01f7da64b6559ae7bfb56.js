    ...
    _createClass(App, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(Body, { currentTemp: this.state.currentTemp }),
...
var Body = (function (_React$Component) {
    ...
    _createClass(Body, [{
        ...
        value: function getData() {
            ...
            $.getJSON('https://api.openweathermap.org/data/2.5/weather?zip=10001,us&APPID=97ba0137a822f0aa0167956e1aa88b78', function (response) {
                var currentTimeArr = _this.state.timeArr;
                if (currentTimeArr.length > 10) {
                    _this.state.timeArr.shift();
                    _this.state.tempArr.shift();
                }

                var convertedTime = moment.unix(response.dt).format('h:mm:ss a');
                _this.setState({
                    data: response,
                    timeArr: [].concat(_toConsumableArray(_this.state.timeArr), [convertedTime]),
                    tempArr: [].concat(_toConsumableArray(_this.state.tempArr), [response.main.temp])
                });
            });
        }
    }, {
            ...
            return React.createElement(
                ...
                React.createElement(
                    ...
                    React.createElement(
                        'div',
                        { className: 'row' },
                        React.createElement(FundChart, { time: this.state.timeArr, temp: this.state.tempArr, data: this.state.data })
                    ),
                    React.createElement(
                        'div',
                        { className: 'row' },
                        React.createElement(Report, { data: this.state.data })
                    )
                )
            );
        }
...
var Footer = (function (_React$Component) {
    ...
    _createClass(Footer, [{
        key: 'render',
        value: function render() {
            return React.createElement('div', { style: footBG });
        }
    }]);
...
var FundChart = (function (_React$Component) {
    _inherits(FundChart, _React$Component);

    function FundChart(props) {
        _classCallCheck(this, FundChart);

        _get(Object.getPrototypeOf(FundChart.prototype), 'constructor', this).call(this, props);
        this.state = {
    ...
    _createClass(FundChart, [{
        ...
        value: function render() {
            return React.createElement(
                'div',
                { className: 'col-12' },
                React.createElement('canvas', { style: chartBG, id: 'myChart' })
            );
        }
    }]);
    ...
    _createClass(NavBar, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    "nav",
                    { style: navBG, className: "navbar navbar-light bg-faded" },
                    React.createElement(
                        "div",
                        { className: "container" },
                        React.createElement("img", { className: "logo", alt: "Fund That Flip logo", src: "https://cdn.fundthatflip.com/assets/final_navbar_logocs-ada796bc16394059988c2e9f5244bd7cd3b275b9bdd91c783a587d374bcd0374.svg" })
                    )
                )
            );
        }
...
var Report = (function (_React$Component) {
    ...
    function Report(props) {
        ...
        _get(Object.getPrototypeOf(Report.prototype), "constructor", this).call(this, props);
        this.state = {
    ...
    _createClass(Report, [{
        ...
        value: function componentWillReceiveProps(nextProps) {
            ...
            this.setState({
                ...
                data: [].concat(_toConsumableArray(this.state.data), [nextProps.data])
        ...
        value: function render() {
            return React.createElement(
                "div",
                { className: "col-12", style: reportBG },
                React.createElement(
                    "h3",
                    null,
                    "Report"
...
var Rows = (function (_React$Component) {
    ...
    function Rows(props) {
        ...
        _get(Object.getPrototypeOf(Rows.prototype), 'constructor', this).call(this, props);
        this.state = {
            data: this.props.data
        };
            ...
            var rows = this.state.data.map(function (row, index) {
                ...
                return React.createElement(
                    ...
                    React.createElement(
                        'td',
                        null,
                        moment.unix(row.dt).format('MMMM Do YYYY')
                    ),
                    React.createElement(
                        'td',
                        null,
                        moment.unix(row.dt).format('h:mm:ss a')
                    ),
                    React.createElement(
                        'td',
                        null,
    ...
    _createClass(Table, [{
        ...
        value: function render() {
            ...
            return React.createElement(
                ...
                React.createElement(Rows, { data: this.state.data })
            );
        }
    }]);
